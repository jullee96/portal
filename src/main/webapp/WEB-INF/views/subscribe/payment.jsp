...
<head>
  ...
  <title>
    Hamonize Cloud Service | get your domain
  </title>
              ...
              <div class="multisteps-form mb-5">
                ...
                <div class="row">
                  <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form" style="height: 369px;">
                      <!--single form panel-->
                        ...
                        <div class="multisteps-form__content">
                          <div class="row text-start">
                            <div class="col-12 col-md-8 ms-auto mt-3">
                              ...
                              <input class="multisteps-form__input form-control" type="text" placeholder="Eg. Argon">
                            </div>
